...
\title{二次元直交格子を用いたShock-Fitting法の基礎的研究}   %和文タイトルを記して下さい
...
In contrast, the shock-fitting method explicitly represents the shock front by introducing shock-points and applying the Rankine--Hugoniot conditions, allowing accurate tracking of its position and shape while minimizing numerical diffusion effects. 
